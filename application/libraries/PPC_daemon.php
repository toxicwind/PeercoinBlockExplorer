...
class PPC_daemon {
    ...
    ******************************************************************************/
    public static $wallet_ip = "127.0.0.1";
    public static $wallet_port = "9902";
    public static $wallet_user = "USERNAME";
    public static $wallet_pass = "PASSWORD";

    public static $coin_name = "Peercoin";
    ...
    */
    ...
    //  Send the request to the wallet
        $info = $this->wallet_fetch ($request_array);
    ...
    * @return   string
    */
    public function getnetworkhashps ($block_index=NULL)
    {
    //  The JSON-RPC request starts with a method name
    ...
    * @return   mixed
    */
    public function getrawtransaction ($tx_id, $verbose=1)
    {
    //  The JSON-RPC request starts with a method name
    ...
    ******************************************************************************/
    ...
    public function wallet_fetch ($request_array)
    {
    ...
    //  Set the IP address and port for the wallet server
        curl_setopt ($coind, CURLOPT_URL, self::$wallet_ip);
        curl_setopt ($coind, CURLOPT_PORT, self::$wallet_port);
    ...
    //  Provide the username and password for the connection
        curl_setopt($coind, CURLOPT_USERPWD, self::$wallet_user.":".self::$wallet_pass);
